...
impl DocumentStructure {
    ...
    #[staticmethod]    fn from_json(json_str: String) -> pyo3::PyResult<Self> {
        serde_json::from_str::<Self>(&json_str).map_err(|e| pyo3::exceptions::PyValueError::new_err(e.to_string()))
    }
}
...
fn __alef_coerce_dto<T: serde::de::DeserializeOwned>(
    ...
    // A public @dataclass is n        let as_dict = py.import("dataclasses")?.call_method1("asdict", (value,))?;
...
fn __alef_coerce_dto_map<T: serde::de::DeserializeOwned>(
    ...
    // Build a wire-keyed JSON     let mut object = serde_json::Map::with_capacity(items.len());
...
impl AnnotationKind {
    ...
    fn new(
        ...
        // Accept three call shapes            if let Ok(s) = v.extract::<String>() {
...
impl CodeBlockStyle {
    ...
    fn __new__(value: pyo3::Bound<'_, pyo3::PyAny>) -> pyo3::PyResult<Self> {
        use pyo3::prelude::*;
        // Try to extract as string            let s_lower = s.to_lowercase();
        ...
        // Try to extract as intege            match n {
    ...
    fn visit_text(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_text", (_ctx_py, _text)) {
                // Visitor callbacks are in                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
    ...
    fn visit_element_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_element_start", (_ctx_py,)) {
                // Visitor callbacks are infa                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_element_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_element_end", (_ctx_py, _output)) {
                // Visitor callbacks are infall                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_link(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_link", (_ctx_py, _href, _text, _title)) {
                // Visitor callbacks are infallib                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_image(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_image", (_ctx_py, _src, _alt, _title)) {
                // Visitor callbacks are infallible                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_heading(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_heading", (_ctx_py, _level, _text, _id)) {
                // Visitor callbacks are infallible o                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_code_block(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_code_block", (_ctx_py, _lang, _code)) {
                // Visitor callbacks are infallible on                     html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_code_inline(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_code_inline", (_ctx_py, _code)) {
                // Visitor callbacks are infallible on th                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_list_item(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_list_item", (_ctx_py, _ordered, _marker, _text)) {
                // Visitor callbacks are infallible on the                     html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_list_start(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_list_start", (_ctx_py, _ordered)) {
                // Visitor callbacks are infallible on the Ru                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_list_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_list_end", (_ctx_py, _ordered, _output)) {
                // Visitor callbacks are infallible on the Rust                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_table_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_table_start", (_ctx_py,)) {
                // Visitor callbacks are infallible on the Rust s                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_table_row(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_table_row", (_ctx_py, _cells, _is_header)) {
                // Visitor callbacks are infallible on the Rust sid                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_table_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_table_end", (_ctx_py, _output)) {
                // Visitor callbacks are infallible on the Rust side                       html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_strong(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_strong", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — lo                          html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_emphasis(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_emphasis", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log                             html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_strikethrough(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_strikethrough", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log th                              html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_underline(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_underline", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the                                 html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_subscript(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_subscript", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the ho                                  html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_superscript(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_superscript", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the host                                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_button(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_button", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // ex                              html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_audio(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_audio", (_ctx_py, _src)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exce                                html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_video(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_video", (_ctx_py, _src)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // except                                  html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_iframe(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_iframe", (_ctx_py, _src)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exceptio                                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_details(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_details", (_ctx_py, _open)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exception                     html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_summary(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_summary", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exception be                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_figure_start(&mut self, _ctx: &html_to_markdown_rs::NodeContext) -> html_to_markdown_rs::VisitResult {
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figure_start", (_ctx_py,)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exception befo                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_figcaption(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figcaption", (_ctx_py, _text)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exception before                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
    ...
    fn visit_figure_end(
        ...
        Python::attach(|py| {
            ...
            match obj.call_method1("visit_figure_end", (_ctx_py, _output)) {
                // Visitor callbacks are infallible on the Rust side — log the host
                // exception before s                    html_to_markdown_rs::VisitResult::Continue
                }
                Ok(result) => {
                    if let Ok(s) = result.extract::<String>() {
                        match s.as_str() {
...
fn conversion_error_to_py    #[allow(unreachable_patterns)]
    match &e {
